...
public class PlayActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        findViewById(R.id.compress).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                mWaitDialog.setWaitText("正在生成视频,请不要退出...");
                mWaitDialog.show();
    ...
    private void initData() {
        ...
        videoAbsolutePath = getIntent().getStringExtra("path");
        //        textAbsolutePath = intent.getStringExtra("imagePath");

        //获取路径
        String path = Environment.getExternalStorageDirectory() + File.separator + "videoCompress";
        //定义文件名
        String fileName = videoAbsolutePath.substring(videoAbsolutePath.lastIndexOf("/") + 1);
    ...
    private void playVideo(String path) {
        final File file = new File(videoAbsolutePath);
        sendBroadcast(new Intent(Intent.ACTION_MEDIA_SCANNER_SCAN_FILE, Uri.fromFile(file)));
        mVideoView.setVideoPath(videoAbsolutePath);
    ...
    private void goBack() {
        ...
        itt.putExtra("cutPath", outputUrl);
